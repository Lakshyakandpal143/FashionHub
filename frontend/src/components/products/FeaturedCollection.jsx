...
const FeaturedCollection = () => {
    return (
        <section className='py-16 px-4 lg:px-6'>
            <div className='container mx-auto flex flex-col-reverse lg:flex-row items-center bg-purple-100 rounded-3xl'>
                <div className='lg:w-1/2 p-8 text-center lg:text-left'>
                    <h2 className='text-lg font-semibold text-gray-700 mb-2'>Comfort and Style
                    </h2>
